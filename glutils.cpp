...
namespace glutils
{
    ...
    ProgramWorld::ProgramWorld(const std::string &vertname, const std::string &fragname)
    {
    ...
    {
        glVertexAttribPointer(apos, 3, GL_FLOAT, GL_FALSE, 3*sizeof(GLfloat), 0);
    }
    ...
    void ProgramWorld::SetLightDir(const GLfloat *lightdir) const
    {
